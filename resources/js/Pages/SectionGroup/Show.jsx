            ...
            <Box sx={{ pt: 2, pb: 6 }}>
                ...
                {activeTab === 0 && (
                    <>
                            ...
                            <Box sx={{ mb: 5 }}>
                                ...
                                <Grid container spacing={3}>
                                    {sectionGroup.children.map((item) => (
                                        <Grid
                                            size={{ xs: 12, sm: 6, md: getGridSize() }}
                                            key={item.id}
                                        >
                                            <Card
                                                ...
                                                onClick={() =>
                                                    router.visit(
                                                        route('sectionGroups.show', item.id),
                                                    )
                                                }
                                            ...
                                            >
                                                ...
                                                <CardContent sx={{ flexGrow: 1, pt: 0 }}>
                                                    {item.sectionsCount > 0 && (
                                                        <Tooltip
                                                            title={`Contains ${item.sectionsCount} sections`}
                                                            arrow
                                                        >
                                                            <Chip
                                                                size="small"
                                ...
                                <Grid container spacing={3}>
                                    {sectionGroup.sections.map((item) => (
                                        ...
                                        >
                                            <Card
                                                elevation={
                                                    hoveredCard === `section-${item.id}` ? 4 : 1
                                                }
                                                sx={{
                                                    height: '100%',
                                                    display: 'flex',
                                                ...
                                                onMouseEnter={() =>
                                                    handleCardMouseEnter(`section-${item.id}`)
                                                }
                                                onMouseLeave={handleCardMouseLeave}
                                            >
                                                {!item.active && (
                        ...
                        {sectionGroup.children.length === 0 &&
                            sectionGroup.sections.length === 0 && (
                                <Fade in={true} timeout={1000}>
                                    ...
                                    >
                                        ...
                                        >
                                            This section group is empty. You can add sub-groups or
                                            sections to organize your content.
                                        </Typography>
                                    </Paper>
                                </Fade>
                            )}
