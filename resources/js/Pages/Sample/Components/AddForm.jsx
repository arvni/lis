...
const AddForm = ({ open, onClose, defaultValue }) => {
    ...
    const validation = useMemo(() => {
        ...
        const hasInvalidDates = barcodes.some(
            (b) =>
                b.collection_date &&
                b.received_at &&
        ...
        const missingRequiredBarcodes =
            ...
            barcodes.some((b) => b.sampleType?.required_barcode && !b.material?.barcode);
        return {
            isValid:
                !hasIncompleteDates &&
                !hasInvalidDates &&
                            ...
                            <Box display="flex" gap={1.5} sx={{ alignItems: 'center' }}>
                                ...
                                <Box>
                                    <Typography variant="subtitle2" fontWeight={600}>
                                        {validation.completedSamples} of {validation.totalSamples}{' '}
                                        samples completed
                                    </Typography>
                    ...
                    {data?.barcodes?.length > 0 ? (
                        data.barcodes.map((barcode, index) => {
                            ...
                            const showReceivedError =
                                ...
                                (!barcode.received_at ||
                                    new Date(barcode.collection_date) >
                                        ...
                                        <Box sx={{ p: 2.5, bgcolor: 'grey.50' }}>
                                            <Stack spacing={2.5}>
                                                ...
                                                <Box>
                                                    ...
                                                    >
                                                        <Science sx={{ fontSize: 14 }} /> Requested
                                                        Tests
                                                    </Typography>
                                                    <Stack
                                                        direction="row"
