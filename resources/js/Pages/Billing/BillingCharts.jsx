                                ...
                                <TableBody>
                                    {byTest.map((r, i) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">
                                                <b>
                                                    {fmt(r.invoiced_income + r.non_invoiced_income)}
                                                </b>
                                            </TableCell>
                                        </TableRow>
                                    ))}
            ...
            <ChartSection title="Income by Referrer" icon={BarChartIcon} loading={chartsLoading}>
                {byReferrer.length === 0 ? (
                    ...
                    <>
                        <ResponsiveContainer
                            width="100%"
                            height={Math.max(260, byReferrer.length * 40)}
                        >
                            <BarChart
                                data={byReferrer}
                                layout="vertical"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <FormControl fullWidth size="small">
                                ...
                                <Select
                                    ...
                                    onChange={(e) =>
                                        applyTrendFilters({ t_months: e.target.value })
                                    }
                                >
                    ...
                    <>
                        ...
                        >
                            <Typography variant="caption" color="primary.main">
                                Invoiced total:{' '}
                                <b>
                                    OMR {fmt(trendData.reduce((s, r) => s + r.invoiced_income, 0))}
                                </b>
                            </Typography>
                            <Typography variant="caption" color="warning.main">
                                ...
                                <b>
                                    OMR{' '}
                                    {fmt(trendData.reduce((s, r) => s + r.non_invoiced_income, 0))}
                                </b>
                            </Typography>
