...
import {
    Box, Chip, CircularProgress, Divider, FormControl, Grid as Grid,
    InputLabel, MenuItem, Paper, Select, Skeleton, Stack, Table,
    TableBody, TableCell, TableContainer, TableHead, TableRow,
    Typography, alpha, useTheme,
} from '@mui/material';
import { BarChart as BarChartIcon, DonutSmall, ShowChart } from '@mui/icons-material';
...
const BillingCharts = ({
    byTest, byReferrer, byMethod,
    chartsLoading,
    trendData, trendLoading,
    trendFilters, applyTrendFilters,
    trendReferrerObj, setTrendReferrerObj,
    trendTestObjs, setTrendTestObjs,
}) => {
    const theme = useTheme();
    ...
    return (
        <>
            ...
            <ChartSection title="Payments by Method" icon={DonutSmall} loading={chartsLoading}>
                {byMethod.length === 0
                    ? <Typography color="text.secondary" sx={{textAlign: 'center', py: 4}}>No payments</Typography>
                    : (
  ...
  <Stack direction="row" sx={{justifyContent: "center", flexWrap: 'wrap', gap: 3, mt: 2}}>
