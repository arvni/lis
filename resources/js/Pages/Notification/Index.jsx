        ...
        <Container maxWidth="md" sx={{ py: 4 }}>
            ...
            <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
                {selectedNotification && !selectedNotification.read && (
                    <MenuItem
                        onClick={() =>
                            markAsRead(selectedNotification.id).then(() => handleMenuClose())
                        }
                    >
                        Mark as read
                    </MenuItem>
                ...
                {selectedNotification && selectedNotification.read && (
                    <MenuItem
                        onClick={() =>
                            markAsUnread(selectedNotification.id).then(() => handleMenuClose())
                        }
                    >
                        Mark as unread
                    </MenuItem>
                ...
                {selectedNotification && (
                    <MenuItem
                        onClick={() =>
                            deleteNotifications(selectedNotification.id).then(() =>
                                handleMenuClose(),
                            )
                        }
                        sx={{ color: 'error.main' }}
