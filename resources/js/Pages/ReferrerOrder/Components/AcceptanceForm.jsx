                        ...
                        <FormControlLabel
                            control={
                                <Checkbox
                                    ...
                                    onChange={(e) =>
                                        onChange('howReport.sendToReferrer', e.target.checked)
                                    }
                                    color="primary"
                                />
                            }
...
const AcceptanceFormDialog = ({
    ...
    const hasStepErrors = (step) => {
        ...
        switch (step) {
            ...
            case 1:
                return Boolean(errors['howReport.sendToReferrer']);
            default:
                return false;
        }
    };
    ...
    return (
        ...
        >
                    ...
                    <Stepper activeStep={activeStep} alternativeLabel>
                        {steps.map((step, index) => (
                            <Step key={step.label} completed={activeStep > index}>
                                <StepLabel error={hasStepErrors(index)}>{step.label}</StepLabel>
                            </Step>
                        ))}
                    </Stepper>
                </Box>
            ...
            <DialogActions
                sx={{ p: 3, borderTop: 1, borderColor: 'divider', justifyContent: 'space-between' }}
            >
                <Button
                    onClick={handleBack}
