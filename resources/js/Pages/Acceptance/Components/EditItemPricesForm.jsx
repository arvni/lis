    ...
    return (
        ...
        >
                        ...
                        <Table size="small" aria-label="edit item prices table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="right" width={160}>Price</TableCell>
                                    <TableCell align="right" width={160}>Discount</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                            ...
                            <TableFooter>
                                <TableRow>
                                    ...
                                    <TableCell align="right">
                                        <Typography fontWeight="bold">{totals.price.toFixed(2)}</Typography>
                                    </TableCell>
                                    <TableCell align="right">
            ...
            <DialogActions sx={{ p: 2.5 }}>
                <Button onClick={onClose} color="inherit" variant="outlined" disabled={processing} startIcon={<Close />}>
                    Cancel
                </Button>
                <Button
