...
const SamplesIndex = () => {
    ...
    const approve = (id) =>
        router.post(route('qc.samples.approve', id), {}, { preserveState: false });
                        ...
                        <Table size="small">
                            ...
                            <TableBody>
                                ...
                                {samples.data.map((sample) => {
                                    ...
                                    const tests = [
                                        ...new Set(items.map((i) => i.test?.name).filter(Boolean)),
                                    ];
                    ...
                    {samples.last_page > 1 && (
                        ...
                        >
                            <Pagination
                                ...
                                onChange={(_, p) =>
                                    router.get(route('qc.samples.index'), { page: p })
                                }
                                color="primary"
                                showFirstButton
                                showLastButton
            ...
            <Dialog open={rejectDialog.open} onClose={closeRejectDialog} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                        This sample will be marked as rejected and returned to the sample collection
                        queue for re-collection. Please provide a reason for rejection.
                    </Typography>
                    <TextField
                        autoFocus
                        fullWidth
