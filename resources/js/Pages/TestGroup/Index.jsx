...
const Index = () => {
    ...
    const findTestGroup = useCallback(
        (id) => testGroups?.data?.find((testGroup) => testGroup.id === id) ?? { id },
        [testGroups],
    );

    const editTestGroup = useCallback(
        (id) => () => {
    ...
    const deleteTestGroup = useCallback(
        (id) => () => {
    ...
    const pageReload = useCallback(
        (page, filters, sort, pageSize) =>
            router.visit(route('testGroups.index'), {
                data: {
                    page,
                    sort,
                    filters,
    ...
    return (
        <>
            ...
            <PageHeader
                ...
                actions={
                    <Button onClick={addNew} color="success" startIcon={<AddIcon />}>
                        Add New Test Group
                    </Button>
                }
            />
            ...
            >
                <DeleteForm
                    title={`${testGroup?.name} Test Group`}
