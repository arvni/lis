    ...
    return (
        <Paper elevation={3} sx={{ p: 1.5, minWidth: 200 }}>
            ...
            <Typography variant="caption" display="block">
                Avg: <b>{d.avg_days} working days</b>
            </Typography>
            <Typography variant="caption" display="block">
                Min: {d.min_days}d — Max: {d.max_days}d
            </Typography>
            <Typography variant="caption" display="block">
                Count: {d.count} reports
            </Typography>
            {d.target_days != null && (
                <Typography
                    variant="caption"
                    display="block"
                    color={d.on_target ? 'success.main' : 'error.main'}
                >
                ...
                {analyticsLoading ? (
                    ...
                    <Box sx={{ py: 6, textAlign: 'center' }}>
                        <Typography color="text.secondary">
                            No published reports in this period.
                        </Typography>
                    </Box>
                ) : (
                    <>
                        ...
                        <Stack direction="row" spacing={2} mt={1} sx={{ justifyContent: 'center' }}>
                            ...
                            <Stack direction="row" spacing={0.5}>
                                ...
                                />
                                <Typography variant="caption">Over target</Typography>
                            </Stack>
                            <Stack direction="row" spacing={0.5}>
                                <Box
                                    sx={{
                                ...
                                />
                                <Typography variant="caption">No target set</Typography>
                            </Stack>
                        </Stack>
                    </>
                )}
                ...
                <Paper elevation={1} sx={{ borderRadius: 2, overflow: 'hidden' }}>
                    <Box sx={{ p: 2, borderBottom: `1px solid ${theme.palette.divider}` }}>
                        <Typography variant="subtitle1" fontWeight="bold">
                            Details ({analyticsData.length} tests)
                        </Typography>
                    </Box>
                    <TableContainer>
                        <Table size="small">
