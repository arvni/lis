...
const ReactPaintMUI = ({ defaultImage = null, onChange = () => {} }) => {
    ...
    const drawNumber = useCallback(
        (ctx, centerX, centerY, size, number) => {
            ctx.save();
    ...
    const drawCursorPreview = useCallback(() => {
        ...
        if (tool === 'eraser') {
            ...
            ['rectangle', 'circle', 'diamond', 'triangle', 'arrow'].includes(tool) ||
            tool.startsWith('number')
        ) {
            ctx.strokeStyle = color;
        ...
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                >
                    <Toolbar
                        variant="dense"
                        sx={{ minHeight: 48, gap: 2, flexWrap: 'wrap', py: 1 }}
                    >
                        {/* Tools */}
                                ...
                                <Slider
                                    ...
                                    disabled={
                                        ![
                                            ...
                                            'triangle',
                                            'arrow',
                                        ].includes(tool) && !tool.startsWith('number')
                                    }
                                    sx={{ mt: -0.5 }}
                                />
                            </Box>
