...
const OrderMaterialsIndex = () => {
    ...
    const findOrderMaterial = useCallback(
        (id) => {
            return (
                orderMaterials.data.find((orderOrderMaterial) => orderOrderMaterial.id === id) ?? {
                    id,
                }
            );
        },
    ...
    const handleEditOrderMaterial = useCallback(
        (id) => () => {
            setLoading(true);
            axios
                .get(route('api.orderMaterials.show', id))
                .then(({ data }) => {
    ...
    const handleDeleteOrderMaterial = useCallback(
        (id) => () => {
    ...
    const columns = useMemo(
        ...
        [handleEditOrderMaterial, handleDeleteOrderMaterial],
    );
    return (
        <>
