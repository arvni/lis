        ...
        async (index, value) => {
            ...
            if (dup !== -1) {
                setMaterialErrors((prev) => ({
                    ...prev,
                    [index]: `Duplicate — already entered in #${dup + 1}`,
                }));
                return;
            }
            ...
            try {
                ...
                setMaterialErrors((prev) => ({
                    ...prev,
                    [index]: err.response?.data?.message || 'Invalid barcode',
                }));
                setData((prev) => {
                    const mats = [...prev.materials];
                    mats[index] = { id: null, barcode: value };
        ...
        >
                    ...
                    <Paper variant="outlined" sx={{ p: 2.5, borderRadius: 2 }}>
                        ...
                        <Stack spacing={2}>
                            ...
                            <TextField
                                ...
                                value={data.amount}
                                onChange={(e) =>
                                    setData('amount', Math.max(1, parseInt(e.target.value) || 1))
                                }
                                error={!!errors.amount}
                    ...
                    <Paper variant="outlined" sx={{ p: 2.5, borderRadius: 2 }}>
                        ...
                        >
                            ...
                            <Chip
                                ...
                                color={
                                    verifiedCount === data.materials.length &&
                        ...
                        {!data.sample_type_id ? (
                            ...
                            <Stack spacing={1.5}>
                                {data.materials.map((mat, idx) => {
                                    const err =
                                        materialErrors[idx] || errors[`materials.${idx}.id`];
                                    ...
                                    return (
                                        ...
                                        >
                                            <TextField
                                                ...
                                                value={mat.barcode}
                                                onChange={(e) =>
                                                    handleBarcodeChange(idx, e.target.value)
                                                }
                                                onBlur={(e) =>
                                                    handleBarcodeBlur(idx, e.target.value)
                                                }
                                                error={!!err}
            ...
            <DialogActions sx={{ px: 3, pb: 2.5, borderTop: '1px solid', borderColor: 'divider' }}>
                ...
                <Button
                    ...
                    disabled={!canSubmit}
                    startIcon={
                        processing ? <CircularProgress size={16} color="inherit" /> : <Add />
                    }
                >
