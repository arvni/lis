        ...
        <Box ref={setNodeRef} style={style}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{display: "flex", alignItems: "center", gap: 1}}>
                        ...
                        <Tooltip title="Edit section">
                            <IconButton size="small" onClick={() => onEdit(sw.id)}
                                        sx={{"&:hover": {color: "warning.main"}, color: "text.disabled"}}>
                                <EditIcon sx={{fontSize: 16}}/>
                            </IconButton>
                        </Tooltip>
                        <Tooltip title="Remove section">
                            <IconButton size="small" onClick={() => onRequestDelete(sw)}
                    ...
                    {sw.parameters?.length > 0 && (
                        <Box sx={{display: "flex", flexWrap: "wrap", gap: 0.5, mt: 1.25, pl: 3.5}}>
            ...
            {idx < total - 1 && (
                <Box sx={{display: "flex", alignItems: "center", pl: "17px", py: 0.25}}>
                    <ArrowDownwardIcon sx={{fontSize: 14, color: alpha(theme.palette.primary.main, 0.35)}}/>
                </Box>
            )}
        </Box>
    );
...
export default function WorkflowForm({data, setData, submit, cancel, errors}) {
    ...
    const handleDragEnd = ({active, over}) => {
        ...
        setData(prev => ({...prev, section_workflows: arrayMove(prev.section_workflows, oldIndex, newIndex)}));
    };
    ...
    return (
        <>
            <PageHeader
                ...
                subtitle={isEdit ? "Modify sections and parameters of this workflow" : "Define the lab section pipeline for this workflow"}
                    ...
                    <Card sx={{
                        ...
                        <Box sx={{
                            ...
                            <Typography variant="overline" fontWeight={700} color="primary.main"
                                        letterSpacing="0.12em" display="block" sx={{mb: 0.25}}>
                        ...
                        <CardContent sx={{p: 3, display: "flex", flexDirection: "column", gap: 2.5}}>
                            ...
                            >
                                ...
                                <Switch
                                    ...
                                    color="success"
                                    name="status"
                                    onChange={e => { e.stopPropagation(); setData(prev => ({...prev, status: e.target.checked})); }}
            ...
            <DeleteForm
                ...
                agreeCB={() => { deleteSection(deleteTarget.id); setDeleteTarget(null); }}
