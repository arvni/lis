...
import { DialogActions, Dialog, DialogTitle, Button, DialogContent } from '@mui/material';
import { router } from '@inertiajs/react';

import SelectSearch from '@/Components/SelectSearch';
import Grid from '@mui/material/Grid';

const CopyForm = ({ open, referrer, onClose }) => {
    ...
    return (
        <Dialog
            ...
            sx={{ p: '5em' }}
        >
            <DialogTitle>Copy Test Price List From Other Referrer</DialogTitle>
            <DialogContent>
