...
const Filter = ({ defaultValues, onFilter }) => {
    ...
    const handleUnmatchedChange = (e) => {
        const { checked } = e.target;
        setFilters((prevState) => ({ ...prevState, unmatched: checked ? '1' : '' }));
    };
                    ...
                    <Grid container spacing={2} alignItems="center">
                        ...
                        <Grid size={{ xs: 12, md: 3 }}>
                            <FormControlLabel
                                control={
                                    <Switch
                                        checked={filters.unmatched === '1'}
                                        onChange={handleUnmatchedChange}
                                    />
                                }
                                label="Only unmatched IDs"
                            />
                        </Grid>
                        <Grid size={{ xs: 12 }}>
