        ...
        <>
            ...
            <Grid container spacing={3} sx={{ mb: 3 }}>
                ...
                <Grid size={{ xs: 12, md: 7 }}>
                    <Grid container spacing={2}>
                        {[
                            {
                                label: 'Total Received (base)',
                                value: totalIn.toFixed(4),
                                color: 'success.main',
                            },
                            {
                                label: 'Total Consumed (base)',
                                value: totalOut.toFixed(4),
                                color: 'error.main',
                            },
                            {
                                label: 'Current Balance (base)',
            ...
            <Card>
                <CardHeader
                    ...
                    subheader="All approved transactions that touched this lot"
                />
                                ...
                                <TableRow>
                                    <TableCell colSpan={9} align="center" sx={{ py: 4 }}>
                                        <Typography color="text.secondary">
                                            No transaction history found for this lot.
                                        </Typography>
                                    </TableCell>
                                </TableRow>
                            )}
