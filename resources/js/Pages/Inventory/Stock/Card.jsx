                        ...
                        <CardContent>
                            ...
                            <Grid container spacing={1}>
                                {[
                                    ...
                                    [
                                        'Base Unit',
                                        `${item.default_unit?.name} (${item.default_unit?.abbreviation})`,
                                    ],
                                ].map(([label, value]) => (
                    ...
                    <Card sx={{ height: '100%' }}>
                        <CardContent>
                            ...
                            <TextField
                                ...
                                value={storeId || ''}
                                onChange={(e) =>
                                    router.visit(route('inventory.stock.card', item.id), {
                                        data: { store_id: e.target.value || undefined },
                                    })
                                }
                            >
                                    ...
                                    {lots.map((lot) => {
                                        ...
                                        return (
                                            <TableRow
                                                ...
                                                onClick={() =>
                                                    router.visit(
                                                        route('inventory.lots.show', lot.id),
                                                    )
                                                }
                                            >
                                                <TableCell>
