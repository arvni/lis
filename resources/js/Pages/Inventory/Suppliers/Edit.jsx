...
const Edit = () => {
    ...
    const addContact = () =>
        setData('contacts', [
            ...data.contacts,
            { name: '', title: '', phone: '', mobile: '', email: '', is_primary: false },
        ]);
    const removeContact = (idx) =>
        setData(
            'contacts',
            data.contacts.filter((_, i) => i !== idx),
        );
            ...
            >
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid size={{ xs: 12, md: 6 }}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        setData('commercial_registration', e.target.value)
                                    }
                                />
                            </Grid>
                            <Grid size={12}>
                ...
                <Card>
                                ...
                                <Grid container spacing={2} sx={{ alignItems: 'center' }}>
                                    ...
                                    <Grid size={{ xs: 12, md: 2 }}>
                                        <TextField
                                            ...
                                            onChange={(e) =>
                                                updateContact(idx, 'mobile', e.target.value)
                                            }
                                        />
                                    </Grid>
                                    <Grid size={{ xs: 12, md: 2 }}>
                    ...
                    <CardContent sx={{ display: 'flex', gap: 2 }}>
                        <Button
                            onClick={() =>
                                router.visit(route('inventory.suppliers.show', supplier.id))
                            }
                        >
                            Cancel
                        </Button>
...
Edit.layout = (page) => (
    <AuthenticatedLayout auth={page.props.auth} breadcrumbs={breadcrumbs(page.props.supplier)}>
        {page}
    </AuthenticatedLayout>
);
