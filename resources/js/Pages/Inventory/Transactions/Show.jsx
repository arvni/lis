                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                        ...
                        {canPrintLabels && (
                            <Button
                                ...
                                onClick={() =>
                                    router.visit(
                                        route('inventory.transactions.labels', transaction.id),
                                    )
                                }
                            >
                                Print Labels
                            ...
                            action={
                                <Box sx={{ pt: 1, pr: 1, display: 'flex', gap: 0.5 }}>
                                    <Chip
                                        ...
                                        color={
                                            TYPE_COLORS[transaction.transaction_type] || 'default'
                                        }
                                        size="small"
                                        variant="outlined"
                                    />
                                ...
                                <TableBody>
                                    {transaction.lines?.map((line) => (
                                        <TableRow key={line.id} hover>
                                            ...
                                            <TableCell align="right">
                                                {line.total_price
                                                    ? Number(line.total_price).toLocaleString(
                                                          undefined,
                                                          { minimumFractionDigits: 2 },
                                                      )
                                                    : '—'}
