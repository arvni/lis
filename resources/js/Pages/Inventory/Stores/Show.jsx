...
const AddLocationForm = ({ storeId, onClose }) => {
    ...
    const preview =
        [data.zone, data.row, data.column, data.shelf, data.bin].filter(Boolean).join('-') || '—';
            ...
            <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, sm: 2 }}>
                    <TextField
                        ...
                        value={data.capacity_notes}
                        onChange={(e) => setData('capacity_notes', e.target.value)}
                    />
                </Grid>
            </Grid>
                    ...
                    <Card>
                        <CardHeader
                            ...
                            action={
                                <Box sx={{ pt: 1, pr: 1 }}>
                                    <Button
                                        startIcon={showAddForm ? <ExpandMoreIcon /> : <AddIcon />}
                                        size="small"
                                        variant="outlined"
...
Show.layout = (page) => (
    <AuthenticatedLayout auth={page.props.auth} breadcrumbs={breadcrumbs(page.props.store)}>
        {page}
    </AuthenticatedLayout>
);
