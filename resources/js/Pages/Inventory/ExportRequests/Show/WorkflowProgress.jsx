...
const WorkflowProgress = ({ approvals, canAct, requestId, users }) => {
    ...
    const submitApprove = () => {
        approveForm.post(route('inventory.export-requests.approve-step', requestId), {
            onSuccess: () => approveForm.reset(),
        });
    };

    const submitReject = () => {
        rejectForm.post(route('inventory.export-requests.reject-step', requestId), {
            onSuccess: () => {
                rejectForm.reset();
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button
                        ...
                        onClick={() =>
                            delegateForm.post(
                                route('inventory.export-requests.delegate-step', requestId),
                                {
                                    onSuccess: () => {
                                        delegateForm.reset();
