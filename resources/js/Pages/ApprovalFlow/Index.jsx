...
const Index = () => {
    ...
    const findApprovalFlow = useCallback(
        (id) => approvalFlows.data.find((flow) => flow.id === id),
        [approvalFlows],
    );

    const editApprovalFlow = useCallback(
        (id) => () => {
    ...
    const handleDestroy = useCallback(
        () =>
            router.post(
                route('approvalFlows.destroy', approvalFlow.id),
                { _method: 'delete' },
    ...
    return (
        <>
            ...
            {openDeleteForm && (
                <DeleteForm
                    title={`${approvalFlow?.name} Approval Flow`}
