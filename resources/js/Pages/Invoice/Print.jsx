                                ...
                                <TableCell sx={{ border: '2px solid', padding: 0, width: '80mm' }}>
                                    ...
                                    >
                                        ...
                                        <TableRow>
                                            ...
                                            >
                                                <>
                                                    Alley 3703,No.346,South Al Ghoubrah St. Muscat,
                                                    Sultanat of Oman
                                                </>
                                            </TableCell>
                                        </TableRow>
                                ...
                                <TableCell sx={{ border: '2px solid', padding: 0, width: '80mm' }}>
                                    ...
                                    >
                                        ...
                                        <TableRow>
                                            ...
                                            >
                                                زقاق ۳۷۰۳، رقم ۳۴۶، الغبرة الجنوبية،محافظة مسقط،
                                                سلطنة عمان
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                    ...
                                    <Table sx={{ '& td': { paddingY: '5px', border: 'none' } }}>
                                        <TableRow>
                                            <TableCell colSpan={2}>
                                                ...
                                                {invoice?.owner?.billingInfo?.name ??
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={2}>
                                                ...
                                                {invoice?.acceptance?.out_patient
                                                    ? 'Out Patient'
                                                    : 'In Bion'}
                                            </TableCell>
                                        </TableRow>
                                        ...
                                        <Table sx={{ '& td': { paddingY: '5px', border: 'none' } }}>
                                            ...
                                            <TableRow>
                                                <TableCell colSpan={2}>
                                                    ...
                                                    {invoice?.acceptance?.referrer_order
                                                        ?.orderInformation?.patient?.reference_id ??
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell sx={{ textAlign: 'center' }}>
                                                {invoice.has_different_owner
                                                    ...
                                                    : Math.floor(
                                                          invoice.acceptance_items_sum_price * 1 -
                                                              invoice.acceptance_items_sum_discount *
                                                                  1,
                                                      )}
                                            </TableCell>
                                            <TableCell />
