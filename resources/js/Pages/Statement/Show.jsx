            ...
            >
                ...
                <Box sx={{ textAlign: 'center', mb: 3 }}>
                    <Typography
                        variant="h4"
                        fontWeight="bold"
                        sx={{ color: '#2E5090', letterSpacing: 1 }}
                    >
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <Paper
                        variant="outlined"
                        sx={{ p: 2, minWidth: 300, borderColor: '#2E5090', borderWidth: 2 }}
                    >
                        <Typography
                            variant="subtitle1"
                            fontWeight="bold"
                ...
                <Box sx={{ mt: 4, textAlign: 'center' }}>
                    <Typography variant="caption" color="text.disabled">
                        Generated on: {statement.generated_at} &nbsp;|&nbsp; Statement:{' '}
                        {statement.no}
                    </Typography>
                </Box>
            </Paper>
...
const MetaRow = ({ label, value, bold }) => (
    <Box sx={{ display: 'flex', gap: 1, mb: 0.5 }}>
        ...
        <Typography variant="body2" fontWeight={bold ? 'bold' : 'medium'}>
            {value}
        </Typography>
    </Box>
);
