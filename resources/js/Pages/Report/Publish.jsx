...
const PublishingQueue = () => {
    ...
    const handleQuickPublish = useCallback((acceptanceId) => {
        ...
        router.put(
            route('acceptances.publish', acceptanceId),
            {
        ...
        () => [
            ...
            },
            {
                ...
                renderCell: ({ row }) => {
                    ...
                    const testNames =
                        row.acceptance_items?.map((item) => item.test?.name).join(', ') ||
                        'No tests';
        ...
        <>
            ...
            <TableLayout
                ...
                emptyStateProps={{
                    ...
                    description:
                        'Acceptances will appear here once all their reports are approved and ready for publishing.',
