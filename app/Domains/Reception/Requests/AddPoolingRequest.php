...
class AddPoolingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'acceptanceItems.tests.*.original_acceptance_item_ids'                    => 'nullable|array',
            'acceptanceItems.tests.*.original_acceptance_item_ids.*'                  => 'integer|exists:acceptance_items,id',
            ...
            'acceptanceItems.panels.*.original_acceptance_item_ids'                   => 'nullable|array',
            'acceptanceItems.panels.*.original_acceptance_item_ids.*'                 => 'integer|exists:acceptance_items,id',
