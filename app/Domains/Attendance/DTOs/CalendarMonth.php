...
final readonly class CalendarMonth
{
     ...
     * @param  array{scheduled_minutes: int, worked_minutes: int, overtime_minutes: int, late_minutes: int, early_leave_minutes: int, leave_minutes: int, present_days: int, absent_days: int, leave_days: int, corrected_days: int}  $totals
     */
