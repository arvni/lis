...
use App\Http\Controllers\Inventory\RecalculateStockController;
use App\Http\Controllers\Inventory\RelocateStockLotController;
...
use App\Http\Controllers\Inventory\StockExportRequestController;
...
Route::group(['prefix' => 'inventory', 'as' => 'inventory.'], function () {
    ...
    Route::resource('export-requests', StockExportRequestController::class)->parameters(['export-requests' => 'exportRequest'])->except('destroy');
    Route::get('export-requests/{exportRequest}/fulfill', [StockExportRequestController::class, 'fulfill'])->name('export-requests.fulfill');
    Route::post('export-requests/{exportRequest}/fulfill', [StockExportRequestController::class, 'storeFulfillment'])->name('export-requests.store-fulfillment');
    Route::post('export-requests/{exportRequest}/cancel', [StockExportRequestController::class, 'cancel'])->name('export-requests.cancel');
    Route::post('export-requests/bulk-approve', [StockExportRequestController::class, 'bulkApprove'])->name('export-requests.bulk-approve');
    Route::post('export-requests/{exportRequest}/recall', [StockExportRequestController::class, 'recall'])->name('export-requests.recall');
    Route::post('export-requests/{exportRequest}/comments', [StockExportRequestController::class, 'addComment'])->name('export-requests.comments.store');
    Route::post('export-requests/{exportRequest}/approve-step', [StockExportRequestController::class, 'approveStep'])->name('export-requests.approve-step');
    Route::post('export-requests/{exportRequest}/delegate-step', [StockExportRequestController::class, 'delegateStep'])->name('export-requests.delegate-step');
    Route::post('export-requests/{exportRequest}/reject-step', [StockExportRequestController::class, 'rejectStep'])->name('export-requests.reject-step');
    ...
    Route::post('stock-card/{item}/recalculate', RecalculateStockController::class)->name('stock.recalculate');
    ...
    Route::post('lots/{lot}/relocate', RelocateStockLotController::class)->name('lots.relocate');
